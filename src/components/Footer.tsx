      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Ghanaian Artisan Market</h3>
            <p className="text-primary-foreground/80 mb-4 max-w-md">
              Connecting communities through authentic, Ghanaian-made products. 
              Proudly promoting Ghanaian artisans and farmers since 2020.
            </p>
        ...
        <div className="border-t border-primary-foreground/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-primary-foreground/60 text-small">
            © 2024 Ghanaian Artisan Market. All rights reserved.
          </p>
